...
public class postagemController {
 ...
 @PostMapping("/home/new")//essa notação inidica que vamos ler algum conteudo do usuario e passamos a 
 ...
 public ResponseEntity<Postagem> alterarPostagem(@RequestBody Postagem postagem){
	 ...
	 return ResponseEntity.ok(postagem);//e retornamos a palavra "sucesso" *OBS: mesmo que a
